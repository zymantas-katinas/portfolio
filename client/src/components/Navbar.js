...
function Navbar() {
  ...
  const handleClickAbout = () => {
    if (!aboutPosition) {
      ...
      projectsPosition && dispatch(projectsAway())
      contactPosition && dispatch(contactAway())
    }
  }
  ...
  return (
    <div className="navbar">
      <div className={projectsPosition ? "selected" : undefined}>
        <h2 onClick={handleClickProjects}>Projects</h2>
      </div>
      <div className={aboutPosition ? "selected" : undefined }>
        <h2 onClick={handleClickAbout}>Who am I?</h2>
      </div>
      <div className={contactPosition ? "selected" : undefined}>
